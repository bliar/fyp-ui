    ...
    $.fn.convform = function(options){
        ...
        */
        ...
        if(inputs.length) {
            ...
            switch(parameters.typeInputUi) {
                case 'input':
                    inputForm = $('<form id="' + parameters.formIdName 
                                               ...
                                               + '" class="userInputDynamic"></><button id="start_button" onclick="startButton(event)"><img id="start_img" src="../fyp-chatbot/mic.gif" alt="Start"></button><button type="submit" class="submit">'
            ...
            $(start_img).click(function(event){
                console.log("In the start button function");
                if (recognizing){
                    recognition.stop();
                    return;
                }
